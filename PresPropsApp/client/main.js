...
angular.module('presidential', [
    angularMeteor
  ])
  .controller('ApartmentsListCtrl', ['$scope', function($scope) {
    $scope.apartments = [
{title: 'Newly Renovated Back Bay 1 Bedroom Available December 1', price: '$2,500.00', bedrooms: '1' ,bathrooms: '1' , type: 'Apartment' , status: 'For Rent' , piclink: 'http://yourbostonapartments.com/wp-content/uploads/2016/11/733b5bba.jpg' },
{title: 'Large Back Bay 2 Bed/ 2 Bath w/ Private Deck Available NOW!', price: '$4,500.00', bedrooms: '2' ,bathrooms: '2' , type: 'Apartment' , status: 'For Rent' , piclink: 'http://yourbostonapartments.com/wp-content/uploads/2016/11/241b1bba.jpg' },
